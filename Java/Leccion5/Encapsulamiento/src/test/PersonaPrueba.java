...
public class PersonaPrueba {
    public static void main(String[] args) {
        ...
        Persona persona2 = new Persona("Erwin", 214.000, false);
        System.out.println("persona2 su nombre es: "+persona1.getNombre());
        persona2.setNombre("Yamil Citadino");
        System.out.println("persona2 con su nombre modificado: "+persona2.getNombre());
        System.out.println("person2 el resultado para el sueldo: "+persona2.getSueldo());
