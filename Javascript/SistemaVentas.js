...
class Orden{
    ...
    static getMAX_PRODUCTOS(){ //Siula una constante
        return 5;
    }
    ...
    agregarProducto(producto){
        if(this._productos.length < Orden.getMAX_PRODUCTOS()){
            ...
            //this.productos[this._contadorProductosAgregados++] = producto; // segunda sintaxis
        }
        else{
    ...
    mostrarOrden(){
        ...
        console.log(`Orden: ${this._idOrden}, Total: $${this.calcularToral()}, Productos: ${productosOrden}`)
