...
<style scoped>
  ...
  a{
    border: 1px solid;
    border-color: hsla(160, 93%, 54%, 0.2);
    /*Elimina lo subrayado de los enlaces y elemementos con clase "Green"*/
    border-radius: 5px;
    text-decoration: none;
  ...
  a:hover{
  /* Cambia el color de fondo al pasar el moyse sobre un enlace*/
